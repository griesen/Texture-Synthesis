...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_stim4a_diag/test_real.npy', 
                         ...
                         mean=mean, save_dir = '/home/ubuntu/test_audio_stim4a_diag/things/', save_freq=100)
