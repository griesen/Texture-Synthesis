...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_stim1a_diag_t/test_real.npy', 
                         [(im, [('conv1', 1, 'corr_diag_t'), 
                                ('pool1', 1, 'corr_diag_t'), 
                                ('conv2', 1, 'corr_diag_t'), 
                                ('pool2', 1, 'corr_diag_t'), 
                                ('conv3', 1000, 'corr_diag_t'), 
                                ('conv4', 100000, 'corr_diag_t'),  
                                ('conv5', 100000, 'corr_diag_t'), 
                                ('pool5', 100000, 'corr_diag_t'),
                                #('fc6', 100000, 'ss')
                            ])], 'data', seed=2, use_bounds=True, 
                         #start_normal=False, start_im = im,
                         mean=mean, save_dir = '/home/ubuntu/test_audio_stim1a_diag_t/things/', save_freq=100)
