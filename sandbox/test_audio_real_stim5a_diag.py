...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_stim5a_diag/test_real.npy', 
                         [(im, [('conv1', 1, 'corr_diag'), 
                                ('pool1', 1, 'corr_diag'), 
                                ('conv2', 1, 'corr_diag'), 
                                ('pool2', 1, 'corr_diag'), 
                         ...
                         mean=mean, save_dir = '/home/ubuntu/test_audio_stim5a_diag/things/', save_freq=100)
