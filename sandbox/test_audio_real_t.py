...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_real_t/test_real.npy', 
                         [(im, [('conv1', 100, 'corr_t'), 
                                ('pool1', 100, 'corr_t'), 
                                ('conv2', 100, 'corr_t'), 
                                ('pool2', 100, 'corr_t'), 
                         ...
                         seed=2, use_bounds=True, start_normal=False, mean=mean, 
                         save_dir = '/home/ubuntu/test_audio_real_t/things/', save_freq=100)
