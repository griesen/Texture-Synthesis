...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_real_stim1a/test_real.npy', 
                         [(im, [('conv1', .1, 'corr_rs'), 
                                ('pool1', .1, 'corr_rs'), 
                                ('conv2', 1, 'corr_rs'), 
                                ('pool2', 1, 'corr_rs'), 
                                ...
                                ('conv5', 1000000, 'corr_rs'), 
                                ('pool5', 1000000, 'corr_rs'),
                                ('fc6', 1000000, 'ss')
                            ])], 'data', seed=0, use_bounds=True, 
                         mean=mean, save_dir = '/home/ubuntu/test_audio_real_stim1a/things/', save_freq=100)
