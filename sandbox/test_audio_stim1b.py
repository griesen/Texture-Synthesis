...
print(im.shape)
r, targets = thing4.main(pf, sf, '/home/ubuntu/test_audio_real_stim1b/test_real.npy', 
                         [(im, [#('conv1', .1, 'corr_rs'), 
                                ('pool1', 1, 'corr_rs'), 
                                #('conv2', 1, 'corr_rs'), 
                                ('pool2', 1, 'corr_rs'), 
                         ...
                         mean=mean, save_dir = '/home/ubuntu/test_audio_real_stim1b/things/', save_freq=100)
