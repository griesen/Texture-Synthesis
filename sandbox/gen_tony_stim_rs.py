...
im2 = np.asarray(Image.open('/home/ubuntu/textures/campbell256.o.jpg').convert('RGB').resize((227, 227), resample=Image.ANTIALIAS)).transpose(2, 0, 1).reshape((1, 3, 227, 227))
