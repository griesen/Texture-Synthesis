...
r, targets = thing4b.main(pf, sf, '/home/ubuntu/test_fruits_cn_ss2.npy',  [(im2, [('conv1', 1, 'corr'), ('norm1', 1, 'corr'), ('pool1', 1, 'corr'), ('conv2', 1, 'corr', ), ('norm2', 1, 'corr'), ('pool2', 1, 'corr'),  ('conv3', 1, 'corr'), ('conv4', 1, 'corr'), ('conv5', 1 , 'corr'), ('pool5', 1, 'corr'), ('fc6', 2, 'ss'), ('fc7', 2, 'ss')])], use_bounds=True, data_layer='data', crop=(14, -15, 14, -15), seed=0)
