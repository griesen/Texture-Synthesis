...
r, targets = thing4.main(pf, sf, '/home/ubuntu/genstim2.npy',  [(None, [('data', .1, 'smooth'), ('fc8', (100, var), 'max2')])], 'data', use_bounds=True, crop=(14, -15, 14, -15), start_normal=True, seed=2)
