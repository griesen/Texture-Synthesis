...
r, targets = thing4.main(pf, sf, '/home/ubuntu/genstim10a/genstim.npy', 
                         [(None, [('data', .001, 'smooth'), 
                                  #('fc8', (25000, var), 'softmax')
                              ]),
                          ([im], [('fc8', 100000, 'ss'), ('fc7', 100000, 'ss')])],
                     data_layer = 'data', use_bounds=True, crop=(14, -15, 14, -15), 
                     start_normal=True, seed=1, 
                     start_im = im,
                     save_dir='/home/ubuntu/genstim10a/things', save_freq=100)
